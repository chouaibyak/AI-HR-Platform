...
export default function Register() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      {/* Barre bleue en haut - prend toute la largeur */}
      <div className="w-full bg-blue-600 p-4">
        <span className="text-xl font-bold text-white">Humain+</span>
      </div>

      {/* Contenu centré */}
      <div className="flex justify-center items-center min-h-[calc(100vh-4rem)]"> {/* Ajuste la hauteur pour compenser la barre */}
        <div className="border-2 border-gray-200 rounded-lg p-8 flex flex-col w-full max-w-md bg-white shadow-sm mx-4"> {/* mx-4 pour marge sur mobile */}
          {/* Logo/Titre - optionnellement masqué si vous préférez */}
